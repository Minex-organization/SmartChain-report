...
| ![Ethan](../assets/img/chapter1/Yi.png) | **Nombres y Apellidos:** Ethan Raul Yi Torrejon<br> **Código:** U202313434<br> **Carrera:** Ingeniería de Software<br> Soy una persona apasionada por el codigo y la logica de programacion mis lenguajes principales es c++ y python. A parte me gusta mucho todo lo que es la base de datos y manejo de Big Data utilizando Power BI y bases de datos relacional y no relacional o hibrido. |
| | |
